...
export const Sphere = (u:number, v:number, center:vec3=[0,0,0]) => {
...
export const Breather = (u:number, v:number, center:vec3=[0,0,0]) => {
...
export const SievertEnneper = (u:number, v:number, center:vec3=[0,0,0]) => {
    const a = 1.0;
...
export const SnailShell = (u:number, v:number, center:vec3=[0,0,0]) => {
